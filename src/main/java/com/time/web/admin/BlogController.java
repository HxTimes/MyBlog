...
public class BlogController {
    ...
    @GetMapping("/blogs")
    public String blogs(@PageableDefault(size = 5) Pageable pageable, Blog blog, Model model){
    ...
    public String search(@PageableDefault(size = 5) Pageable pageable, Blog blog, Model model){
        model.addAttribute("page",blogService.listBlog(pageable,blog));
